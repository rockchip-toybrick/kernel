...
static int dmaengine_dlp_hw_params(struct snd_pcm_substream *substream,
				   struct snd_pcm_hw_params *params)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, SND_DMAENGINE_DLP_DRV_NAME);
...
static int dmaengine_dlp_open(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, SND_DMAENGINE_DLP_DRV_NAME);
...
static int dmaengine_dlp_close(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, SND_DMAENGINE_DLP_DRV_NAME);
...
static snd_pcm_uframes_t dmaengine_dlp_pointer(struct snd_pcm_substream *substream)
{
	struct dmaengine_dlp_runtime_data *ddrd = substream_to_ddrd(substream);
...
static int dmaengine_dlp_start(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, SND_DMAENGINE_DLP_DRV_NAME);
...
static void dmaengine_dlp_stop(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, SND_DMAENGINE_DLP_DRV_NAME);
...
static int dmaengine_dlp_trigger(struct snd_pcm_substream *substream, int cmd)
{
	struct dmaengine_dlp_runtime_data *ddrd = substream_to_ddrd(substream);
...
static int dmaengine_dlp_new(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, SND_DMAENGINE_DLP_DRV_NAME);
	struct dmaengine_dlp *ddlp = soc_component_to_ddlp(component);
...
static int dmaengine_dlp_copy_user(struct snd_pcm_substream *substream,
...
static int dmaengine_dlp_prepare(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, SND_DMAENGINE_DLP_DRV_NAME);
...
static int dmaengine_dlp_ioctl(struct snd_pcm_substream *substream,
			       unsigned int cmd, void *arg)
{
	return snd_pcm_lib_ioctl(substream, cmd, arg);
}

static int dmaengine_dlp_hw_free(struct snd_pcm_substream *substream)
{
...
static const struct snd_pcm_ops dmaengine_dlp_ops = {
	.open		= dmaengine_dlp_open,
	.close		= dmaengine_dlp_close,
	.ioctl		= dmaengine_dlp_ioctl,
	.hw_params	= dmaengine_dlp_hw_params,
	.hw_free	= dmaengine_dlp_hw_free,
...
static const struct snd_soc_component_driver dmaengine_dlp_component = {
	...
	.ops		= &dmaengine_dlp_ops,
	.pcm_new	= dmaengine_dlp_new,
};

...
#define ICM40680_POWER_UP_TIME 100
...
#define REG_FD_CONFIG_MREG_TOP1			0x66
...
#define ICM42680_MCLK_WAIT_US		20
#define ICM42680_BLK_SEL_WAIT_US		10
#define ICM42680_MADDR_WAIT_US		10
#define ICM42680_M_RW_WAIT_US		10


/* Allowed timestamp period jitter in percent */
#define ICM42680_TS_PERIOD_JITTER	4
...
enum inv_icm42680_sensor_mode {
	INV_ICM42680_SENSOR_MODE_OFF,
	INV_ICM42680_SENSOR_MODE_STANDBY,
	INV_ICM42680_SENSOR_MODE_LOW_POWER,
	INV_ICM42680_SENSOR_MODE_LOW_NOISE,
	INV_ICM42680_SENSOR_MODE_NB,
};
...
#define ICM42680_FIFO_COUNT_LIMIT		 60
#define ICM42680_DATA_BUFF_SIZE 960

// ODR
enum icm42680_odr_index {
	ICM42680_ODR_RESERVED0 = 0,
	ICM42680_ODR_RESERVED1,
	ICM42680_ODR_RESERVED2,
	ICM42680_ODR_8KHZ,
	ICM42680_ODR_4KHZ,
	ICM42680_ODR_2KHZ,
	ICM42680_ODR_1KHZ,
	...
	ICM42680_ODR_50HZ,
	ICM42680_ODR_25HZ,
	ICM42680_NUM_ODRS, /* must be last */
};

struct icm42680_chip_config {
	unsigned int fsr:2;
	unsigned int lpf:3;
...
struct icm42680_data {
	...
	struct icm42680_chip_config chip_config;
	int skip_samples;
	...
	u8  data_buff[ICM42680_DATA_BUFF_SIZE];
};

/* scan indexes follow DATA register order */
enum icm42680_scan_axis {
	ICM42680_SCAN_ACCEL_X = 0,
	ICM42680_SCAN_ACCEL_Y,
	ICM42680_SCAN_ACCEL_Z,
	ICM42680_SCAN_GYRO_X,
	ICM42680_SCAN_GYRO_Y,
	ICM42680_SCAN_GYRO_Z,
	ICM42680_SCAN_TEMP,
	ICM42680_SCAN_TIMESTAMP,
};

enum icm42680_sensor_type {
	ICM42680_ACCEL = 0,
	ICM42680_GYRO,
	ICM42680_TEMP,
	ICM42680_TIMESTAMP,
	ICM42680_NUM_SENSORS /* must be last */
};

#define IIO_TRIGGER 1
#define ICM42680_RESET_FLAG 1
#define ICM42680_DEBUG_FLAG 0

// fifo
#define ICM42680_OUTPUT_DATA_SIZE 24 // align 8, last 8 for timestamp
#define ICM42680_OUTPUT_DATA_SIZE_PULS_ONE 25
#define ICM42680_FIFO_DATUM			   16
#define ICM42680_BYTES_PER_3AXIS_SENSOR   6
#define ICM42680_FIFO_COUNT_BYTE		  2
#define ICM42680_BYTE_FIFO_TEMP		   1
#define ICM42680_FIFO_SIZE				1024

typedef int (*icm42680_bus_setup)(struct icm42680_data *);

extern const struct regmap_config icm42680_regmap_config;
extern const struct dev_pm_ops icm42680_pm_ops;

irqreturn_t icm42680_read_fifo(int irq, void *p);
int icm42680_set_mode(struct icm42680_data *data, enum icm42680_sensor_type t, bool mode);
int icm42680_reset_fifo(struct iio_dev *indio_dev);
int icm42680_core_probe(struct regmap *regmap, int irq, const char *name,
						int chip_type, icm42680_bus_setup bus_setup);
void icm42680_core_remove(struct device *dev);
int icm42680_probe_trigger(struct iio_dev *indio_dev, int irq_type);
int icm42680_set_enable(struct iio_dev *indio_dev, bool enable);

...
static int cam_num;
static struct imx_camera_module imx258[2];

/* ======================================================================== */
/* Base sensor configs */
/* ======================================================================== */

/* MCLK:24MHz  4208x3120  20fps  4Lane   996Mbps/lane */
static struct imx_camera_module_reg imx258_init_tab_4208_3120_20fps[] =
{
	...
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0340, 0x0e},//VTS[15:8]
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0341, 0x88},//VTS[7:0]
	/* ROI Setting */
	...
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x040e, 0x0c},//DIG_CROP_IMAGE_HEIGHT[11:8]
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x040f, 0x30},//DIG_CROP_IMAGE_HEIGHT[7:0]
	...
	/* Output Size Setting */
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x034c, 0x10},//X_OUT_SIZE[12:8]
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x034d, 0x70},//X_OUT_SIZE[7:0]
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x034e, 0x0c},//Y_OUT_SIZE[11:8]
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x034f, 0x30},//Y_OUT_SIZE[7:0]
	/* Integration Time Setting */
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0202, 0x0e},//COARSE_INTEG_TIME[15:8]
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0203, 0x7e},//COARSE_INTEG_TIME[7:0]
	/* Gain Setting */
...
static struct imx_camera_module_reg imx258_init_tab_2096_1560_30fps[] =
{
	...
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0305, 0x04},
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0306, 0x00},
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0307, 0x85},
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x0309, 0x0a},
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x030b, 0x01},
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x030d, 0x02},
	{IMX_CAMERA_MODULE_REG_TYPE_DATA, 0x030e, 0x00},
...
static struct imx_camera_module_config imx258_configs[] = {
	{
		...
		.reg_table = (void *)imx258_init_tab_4208_3120_20fps,
		.reg_table_num_entries = ARRAY_SIZE(imx258_init_tab_4208_3120_20fps),
...
static int imx258_dual_mode(struct imx_camera_module *cam_mod)
{
...
static int imx258_set_flip(struct imx_camera_module *cam_mod,
	...
	int len)
{
	...
	if (!IS_ERR_OR_NULL(cam_mod->active_config)) {
		...
		else if (mode == (IMX_FLIP_BIT_MASK | IMX_MIRROR_BIT_MASK))
...
static struct v4l2_subdev_pad_ops imx258_camera_module_pad_ops = {
...
static struct v4l2_subdev_ops imx258_camera_module_ops = {
	...
	.pad= &imx258_camera_module_pad_ops
};
	...
	const struct i2c_device_id *id)
{
	...
	v4l2_i2c_subdev_init(&imx258[cam_num].sd, client, &imx258_camera_module_ops);

	
	imx258[cam_num].custom = imx258_custom_config;

...
#define MIPI_FREQ_180M			180000000	// 360Mbps

#define SC830AI_MAX_PIXEL_RATE		(MIPI_FREQ_180M / 10 * 2 * SC830AI_4LANES)
...
static const struct sc830ai_mode supported_modes[] = {
	{
		...
		.vts_def = 0x08ec,
		.bus_fmt = MEDIA_BUS_FMT_SBGGR10_1X10,
		.reg_list = sc830ai_4lane_linear10bit_3840x2160_regs,
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 0,
		.bpp = 10,
...
static const struct v4l2_subdev_video_ops sc830ai_video_ops = {
	...
	.g_mbus_config = sc830ai_g_mbus_config,
};
...
static int sc830ai_initialize_controls(struct sc830ai *sc830ai)
{
	...
	pixel_rate = (u32)link_freq_items[mode->mipi_freq_idx] / mode->bpp * 2 * SC830AI_4LANES;

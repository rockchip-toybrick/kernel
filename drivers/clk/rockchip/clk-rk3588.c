...
enum rk3588_plls {
	b0pll, b1pll, lpll, v0pll, aupll, cpll, gpll, npll, ppll, PLL_COUNT
};
...
#define RK3588_CLK_CORE_B0_SEL_CLEAN_MASK	0x3U
#define RK3588_CLK_CORE_B0_SEL_CLEAN_SHIFT	13U
#define RK3588_CLK_CORE_B1_SEL_CLEAN_MASK	0x3U
#define RK3588_CLK_CORE_B1_SEL_CLEAN_SHIFT	5U
#define RK3588_CLK_CORE_B0_GPLL_DIV_MASK	0x1fU
#define RK3588_CLK_CORE_B0_GPLL_DIV_SHIFT	1U
#define RK3588_CLK_CORE_L_SEL_CLEAN_MASK	0x3U
#define RK3588_CLK_CORE_L1_SEL_CLEAN_SHIFT	12U
#define RK3588_CLK_CORE_L0_SEL_CLEAN_SHIFT	5U
#define RK3588_CLK_DSU_SEL_DF_MASK		0x1U
#define RK3588_CLK_DSU_SEL_DF_SHIFT		15U
#define RK3588_CLK_DSU_DF_SRC_MASK		0x3U
#define RK3588_CLK_DSU_DF_SRC_SHIFT		12U
#define RK3588_CLK_DSU_DF_DIV_MASK		0x1fU
#define RK3588_CLK_DSU_DF_DIV_SHIFT		7U
#define RK3588_ACLKM_DSU_DIV_MASK		0x1fU
#define RK3588_ACLKM_DSU_DIV_SHIFT		1U
#define RK3588_ACLKS_DSU_DIV_MASK		0x1fU
#define RK3588_ACLKS_DSU_DIV_SHIFT		6U
#define RK3588_ACLKMP_DSU_DIV_MASK		0x1fU
#define RK3588_ACLKMP_DSU_DIV_SHIFT		11U
#define RK3588_PERIPH_DSU_DIV_MASK		0x1fU
#define RK3588_PERIPH_DSU_DIV_SHIFT		0U
#define RK3588_ATCLK_DSU_DIV_MASK		0x1fU
#define RK3588_ATCLK_DSU_DIV_SHIFT		0U
#define RK3588_GICCLK_DSU_DIV_MASK		0x1fU
#define RK3588_GICCLK_DSU_DIV_SHIFT		5U
...
{										\
	...
	.val = HIWORD_UPDATE(_apllcore, RK3588_CLK_CORE_B0_SEL_CLEAN_MASK,	\
		...
		HIWORD_UPDATE(0U, RK3588_CLK_CORE_B0_GPLL_DIV_MASK,		\
...
{										\
	.reg = RK3588_DSU_CLKSEL_CON((_offs) + (6)),				\
...
{									\
	...
	.val = HIWORD_UPDATE(_seldsu, RK3588_CLK_DSU_DF_SRC_MASK,	\
		...
		HIWORD_UPDATE(((_divdsu) - 1U), RK3588_CLK_DSU_DF_DIV_MASK,	\
...
{									\
	...
	.val = HIWORD_UPDATE(((_aclkm) - 1U), RK3588_ACLKM_DSU_DIV_MASK,	\
			RK3588_ACLKM_DSU_DIV_SHIFT) |			\
		HIWORD_UPDATE(((_aclkmp) - 1U), RK3588_ACLKMP_DSU_DIV_MASK,	\
			RK3588_ACLKMP_DSU_DIV_SHIFT) |			\
		HIWORD_UPDATE(((_aclks) - 1U), RK3588_ACLKS_DSU_DIV_MASK,	\
...
{									\
	...
	.val = HIWORD_UPDATE(((_periph) - 1U), RK3588_PERIPH_DSU_DIV_MASK,	\
...
{									\
	...
	.val = HIWORD_UPDATE(((_gicclk) - 1U), RK3588_GICCLK_DSU_DIV_MASK,	\
			RK3588_GICCLK_DSU_DIV_SHIFT) |			\
		HIWORD_UPDATE(((_atclk) - 1U), RK3588_ATCLK_DSU_DIV_MASK,	\
...
{								\
	.prate = _prate##U,					\
	.pre_muxs = {						\
		RK3588_CORE_B0_SEL(0U),				\
		RK3588_CORE_B1_SEL(0U),				\
		{0}, {0}, {0}, {0}				\
	},							\
	.post_muxs = {						\
...
{								\
	.prate = _prate##U,					\
	.pre_muxs = {						\
		RK3588_CORE_B2_SEL(0U),				\
		RK3588_CORE_B3_SEL(0U),				\
		{0}, {0}, {0}, {0}				\
	},							\
	.post_muxs = {						\
...
{								\
	.prate = _prate##U,					\
	.pre_muxs = {						\
		RK3588_CORE_L_SEL0((0), (0U)),			\
		RK3588_CORE_L_SEL0((1), (0U)),			\
		RK3588_CORE_L_SEL1((3U), (2U)),			\
		RK3588_CORE_L_SEL2((2U), (3U), (3U)),			\
		RK3588_CORE_L_SEL3(4U),				\
		RK3588_CORE_L_SEL4((4U), (4U)),			\
	},							\
	.post_muxs = {						\
...
static struct rockchip_cpuclk_rate_table rk3588_cpub0clk_rates[] __initdata = {
	RK3588_CPUB01CLK_RATE(2496000000, 1U),
	RK3588_CPUB01CLK_RATE(2400000000, 1U),
	RK3588_CPUB01CLK_RATE(2304000000, 1U),
	RK3588_CPUB01CLK_RATE(2208000000, 1U),
	RK3588_CPUB01CLK_RATE(2184000000, 1U),
	RK3588_CPUB01CLK_RATE(2088000000, 1U),
	RK3588_CPUB01CLK_RATE(2040000000, 1U),
	RK3588_CPUB01CLK_RATE(2016000000, 1U),
	RK3588_CPUB01CLK_RATE(1992000000, 1U),
	RK3588_CPUB01CLK_RATE(1896000000, 1U),
	RK3588_CPUB01CLK_RATE(1800000000, 1U),
	RK3588_CPUB01CLK_RATE(1704000000, 0U),
	RK3588_CPUB01CLK_RATE(1608000000, 0U),
	RK3588_CPUB01CLK_RATE(1584000000, 0U),
	RK3588_CPUB01CLK_RATE(1560000000, 0U),
	RK3588_CPUB01CLK_RATE(1536000000, 0U),
	RK3588_CPUB01CLK_RATE(1512000000, 0U),
	RK3588_CPUB01CLK_RATE(1488000000, 0U),
	RK3588_CPUB01CLK_RATE(1464000000, 0U),
	RK3588_CPUB01CLK_RATE(1440000000, 0U),
	RK3588_CPUB01CLK_RATE(1416000000, 0U),
	RK3588_CPUB01CLK_RATE(1392000000, 0U),
	RK3588_CPUB01CLK_RATE(1368000000, 0U),
	RK3588_CPUB01CLK_RATE(1344000000, 0U),
	RK3588_CPUB01CLK_RATE(1320000000, 0U),
	RK3588_CPUB01CLK_RATE(1296000000, 0U),
	RK3588_CPUB01CLK_RATE(1272000000, 0U),
	RK3588_CPUB01CLK_RATE(1248000000, 0U),
	RK3588_CPUB01CLK_RATE(1224000000, 0U),
	RK3588_CPUB01CLK_RATE(1200000000, 0U),
	RK3588_CPUB01CLK_RATE(1104000000, 0U),
	RK3588_CPUB01CLK_RATE(1008000000, 0U),
	RK3588_CPUB01CLK_RATE(912000000, 0U),
	RK3588_CPUB01CLK_RATE(816000000, 0U),
	RK3588_CPUB01CLK_RATE(696000000, 0U),
	RK3588_CPUB01CLK_RATE(600000000, 0U),
	RK3588_CPUB01CLK_RATE(408000000, 0U),
	RK3588_CPUB01CLK_RATE(312000000, 0U),
	RK3588_CPUB01CLK_RATE(216000000, 0U),
	RK3588_CPUB01CLK_RATE(96000000, 0U),
};
...
static struct rockchip_cpuclk_rate_table rk3588_cpub1clk_rates[] __initdata = {
	RK3588_CPUB23CLK_RATE(2496000000, 1U),
	RK3588_CPUB23CLK_RATE(2400000000, 1U),
	RK3588_CPUB23CLK_RATE(2304000000, 1U),
	RK3588_CPUB23CLK_RATE(2208000000, 1U),
	RK3588_CPUB23CLK_RATE(2184000000, 1U),
	RK3588_CPUB23CLK_RATE(2088000000, 1U),
	RK3588_CPUB23CLK_RATE(2040000000, 1U),
	RK3588_CPUB23CLK_RATE(2016000000, 1U),
	RK3588_CPUB23CLK_RATE(1992000000, 1U),
	RK3588_CPUB23CLK_RATE(1896000000, 1U),
	RK3588_CPUB23CLK_RATE(1800000000, 1U),
	RK3588_CPUB23CLK_RATE(1704000000, 0U),
	RK3588_CPUB23CLK_RATE(1608000000, 0U),
	RK3588_CPUB23CLK_RATE(1584000000, 0U),
	RK3588_CPUB23CLK_RATE(1560000000, 0U),
	RK3588_CPUB23CLK_RATE(1536000000, 0U),
	RK3588_CPUB23CLK_RATE(1512000000, 0U),
	RK3588_CPUB23CLK_RATE(1488000000, 0U),
	RK3588_CPUB23CLK_RATE(1464000000, 0U),
	RK3588_CPUB23CLK_RATE(1440000000, 0U),
	RK3588_CPUB23CLK_RATE(1416000000, 0U),
	RK3588_CPUB23CLK_RATE(1392000000, 0U),
	RK3588_CPUB23CLK_RATE(1368000000, 0U),
	RK3588_CPUB23CLK_RATE(1344000000, 0U),
	RK3588_CPUB23CLK_RATE(1320000000, 0U),
	RK3588_CPUB23CLK_RATE(1296000000, 0U),
	RK3588_CPUB23CLK_RATE(1272000000, 0U),
	RK3588_CPUB23CLK_RATE(1248000000, 0U),
	RK3588_CPUB23CLK_RATE(1224000000, 0U),
	RK3588_CPUB23CLK_RATE(1200000000, 0U),
	RK3588_CPUB23CLK_RATE(1104000000, 0U),
	RK3588_CPUB23CLK_RATE(1008000000, 0U),
	RK3588_CPUB23CLK_RATE(912000000, 0U),
	RK3588_CPUB23CLK_RATE(816000000, 0U),
	RK3588_CPUB23CLK_RATE(696000000, 0U),
	RK3588_CPUB23CLK_RATE(600000000, 0U),
	RK3588_CPUB23CLK_RATE(408000000, 0U),
	RK3588_CPUB23CLK_RATE(312000000, 0U),
	RK3588_CPUB23CLK_RATE(216000000, 0U),
	RK3588_CPUB23CLK_RATE(96000000, 0U),
};
...
static struct rockchip_cpuclk_rate_table rk3588_cpulclk_rates[] __initdata = {
	RK3588_CPULCLK_RATE(2208000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(2184000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(2088000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(2040000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(2016000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(1992000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(1896000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(1800000000, 1U, 3U, 1U),
	RK3588_CPULCLK_RATE(1704000000, 0U, 3U, 1U),
	RK3588_CPULCLK_RATE(1608000000, 0U, 3U, 1U),
	RK3588_CPULCLK_RATE(1584000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1560000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1536000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1512000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1488000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1464000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1440000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1416000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1392000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1368000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1344000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1320000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1296000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1272000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1248000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1224000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1200000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1104000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(1008000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(912000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(816000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(696000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(600000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(408000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(312000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(216000000, 0U, 2U, 1U),
	RK3588_CPULCLK_RATE(96000000, 0U, 2U, 1U),
};
...
static struct rockchip_pll_clock rk3588_pll_clks[PLL_COUNT] __initdata = {
...
static struct rockchip_clk_branch rk3588_clk_branches[] __initdata = {
	...
	GATE(ACLK_NPU1, "aclk_npu1", "clk_npu_dsu0", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(27), 0, GFLAGS),
	GATE(HCLK_NPU1, "hclk_npu1", "hclk_npu_root", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(27), 2, GFLAGS),
	GATE(ACLK_NPU2, "aclk_npu2", "clk_npu_dsu0", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(28), 0, GFLAGS),
	GATE(HCLK_NPU2, "hclk_npu2", "hclk_npu_root", CLK_IS_CRITICAL,
	...
	GATE(FCLK_NPU_CM0_CORE, "fclk_npu_cm0_core", "hclk_npu_cm0_root", CLK_IS_CRITICAL,
	...
	GATE(PCLK_NPU_PVTM, "pclk_npu_pvtm", "pclk_npu_root", CLK_IS_CRITICAL,
	...
	GATE(CLK_NPU_PVTM, "clk_npu_pvtm", "xin24m", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(29), 14, GFLAGS),
	GATE(CLK_CORE_NPU_PVTM, "clk_core_npu_pvtm", "clk_npu_dsu0", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(29), 15, GFLAGS),
	GATE(ACLK_NPU0, "aclk_npu0", "clk_npu_dsu0", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(30), 6, GFLAGS),
	GATE(HCLK_NPU0, "hclk_npu0", "hclk_npu_root", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(30), 8, GFLAGS),
	GATE(PCLK_NPU_TIMER, "pclk_npu_timer", "pclk_npu_root", CLK_IS_CRITICAL,
	...
	GATE(CLK_NPUTIMER0, "clk_nputimer0", "clk_nputimer_root", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(29), 8, GFLAGS),
	GATE(CLK_NPUTIMER1, "clk_nputimer1", "clk_nputimer_root", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(29), 9, GFLAGS),
	GATE(PCLK_NPU_WDT, "pclk_npu_wdt", "pclk_npu_root", CLK_IS_CRITICAL,
			RK3588_CLKGATE_CON(29), 10, GFLAGS),
	GATE(TCLK_NPU_WDT, "tclk_npu_wdt", "xin24m", CLK_IS_CRITICAL,
...
static void __init rk3588_clk_init(struct device_node *np)
{
	...
	if (!reg_base) {
		CLK_LOG_ERROR("%s: could not map cru region\n", __func__);
		return;
	}
	...
	if (IS_ERR(ctx)) {
		CLK_LOG_ERROR("%s: rockchip clk init failed\n", __func__);
		iounmap(reg_base);
		return;
	}
